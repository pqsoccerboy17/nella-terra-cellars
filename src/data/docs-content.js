...
export const techStack = {
  platform: [
    { name: 'Commerce7', role: 'Wine club, POS, e-commerce', api: 'REST', auth: 'Basic Auth' },
    { name: 'Tock', role: 'Reservations & experiences', api: 'REST', auth: 'API Key' },
    { name: 'Square', role: 'Walk-in POS, retail, food', api: 'REST', auth: 'Access Token' },
    { name: 'VinoShipper', role: 'DTC compliance & shipping', api: 'REST', auth: 'API Key + Secret' },
  ],
  automation: [
  ...
  output: [
    { name: 'Google Sheets', role: 'Revenue report — one sheet per month', auth: 'Service Account' },
    { name: 'QuickBooks Online', role: 'Journal entries with QB categories', auth: 'OAuth 2.0' },
  ],
}
