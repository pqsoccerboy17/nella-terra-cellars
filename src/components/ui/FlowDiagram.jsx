    ...
    <svg viewBox="0 0 800 260" className="w-full max-w-3xl mx-auto" aria-label="Data flow diagram showing platforms connecting through automation to outputs">
      ...
      {PLATFORMS.map((p, i) => {
        ...
        return (
          ...
          >
            <rect x="10" y={y} width="160" height="42" rx="8" fill="var(--color-accent)" opacity={p.opacity} />
            <text x="90" y={y + 26} textAnchor="middle" fill="white" fontSize="13" fontWeight="600" fontFamily="DM Sans, sans-serif">
              {p.name}
            </text>
            <line x1="175" y1={y + 21} x2="295" y2="125" stroke="var(--color-border)" strokeWidth="1.5" opacity="0.6" />
          </motion.g>
        )
      })}
      ...
      {OUTPUTS.map((o, i) => {
        ...
        return (
          ...
          >
            <line x1="510" y1="125" x2="600" y2={y + 21} stroke="var(--color-border)" strokeWidth="1.5" opacity="0.6" />
